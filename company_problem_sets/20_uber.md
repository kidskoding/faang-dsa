...
Uber - Commonly reported LeetCode/HackerRank/live-coding patterns for Uber SWE interviews
...
4. [Design Linked List](https://leetcode.com/problems/design-linked-list/)
...
8. [Minimum Moves to Reach Target with Rotations](https://leetcode.com/problems/minimum-moves-to-reach-target-with-rotations/)
9. [Employee Free Time](https://leetcode.com/problems/employee-free-time/)
...
14. [Game of Life](https://leetcode.com/problems/game-of-life/)
15. [Add Binary](https://leetcode.com/problems/add-binary/)
...
19. [Minimum Cost to Connect All Points](https://leetcode.com/problems/min-cost-to-connect-all-points/)
...
22. [Video Stitching](https://leetcode.com/problems/video-stitching/)
23. [Minimum Window Subsequence](https://leetcode.com/problems/minimum-window-subsequence/)
24. [Design Twitter](https://leetcode.com/problems/design-twitter/)
...
28. [Reverse Bits](https://leetcode.com/problems/reverse-bits/)
29. [Word Search](https://leetcode.com/problems/word-search/)
30. [Subsets](https://leetcode.com/problems/subsets/)
31. [Closed Island](https://leetcode.com/problems/closed-island/)
32. [Best Time to Buy and Sell Stock II](https://leetcode.com/problems/best-time-to-buy-and-sell-stock-ii/)
33. [Plus One](https://leetcode.com/problems/plus-one/)
34. [Partition Equal Subset Sum](https://leetcode.com/problems/partition-equal-subset-sum/)
35. [Find All Numbers Disappeared in an Array](https://leetcode.com/problems/find-all-numbers-disappeared-in-an-array/)
36. [Logger Rate Limiter](https://leetcode.com/problems/logger-rate-limiter/)
