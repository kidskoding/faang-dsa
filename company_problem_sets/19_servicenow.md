...
ServiceNow - Commonly reported LeetCode/HackerRank/live-coding patterns for ServiceNow SWE interviews
...
3. [Remove Covered Intervals](https://leetcode.com/problems/remove-covered-intervals/)
4. [Valid Parentheses](https://leetcode.com/problems/valid-parentheses/)
5. [Min Stack](https://leetcode.com/problems/min-stack/)
6. [Envelope Nesting](https://leetcode.com/problems/envelope-nesting/)
7. [Spiral Matrix](https://leetcode.com/problems/spiral-matrix/)
8. [Optimal Account Balancing](https://leetcode.com/problems/optimal-account-balancing/)
9. [Design Circular Deque](https://leetcode.com/problems/design-circular-deque/)
...
13. [Design Underground System](https://leetcode.com/problems/design-underground-system/)
14. [Sort Colors](https://leetcode.com/problems/sort-colors/)
15. [Minimum Obstacle Removal to Reach Corner](https://leetcode.com/problems/minimum-obstacle-removal-to-reach-corner/)
16. [Redundant Connection](https://leetcode.com/problems/redundant-connection/)
...
24. [Number of Enclaves](https://leetcode.com/problems/number-of-enclaves/)
...
28. [Perfect Squares](https://leetcode.com/problems/perfect-squares/)
29. [Find All Numbers Disappeared in an Array](https://leetcode.com/problems/find-all-numbers-disappeared-in-an-array/)
30. [Encode and Decode Strings](https://leetcode.com/problems/encode-and-decode-strings/)
31. [Logger Rate Limiter](https://leetcode.com/problems/logger-rate-limiter/)
