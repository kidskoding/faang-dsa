...
Databricks - Commonly reported LeetCode/HackerRank/live-coding patterns for Databricks SWE interviews
...
5. [Logger Rate Limiter](https://leetcode.com/problems/logger-rate-limiter/)
...
16. [Design Add and Search Words Data Structure](https://leetcode.com/problems/design-add-and-search-words-data-structure/)
...
19. [My Calendar I](https://leetcode.com/problems/my-calendar-i/)
20. [Longest Consecutive Sequence](https://leetcode.com/problems/longest-consecutive-sequence/)
21. [Valid Number](https://leetcode.com/problems/valid-number/)
22. [Path with Maximum Probability](https://leetcode.com/problems/path-with-maximum-probability/)
23. [Count Subtrees With Max Distance Between Cities](https://leetcode.com/problems/count-subtrees-with-max-distance-between-cities/)
24. [Binary Tree Level Order Traversal](https://leetcode.com/problems/binary-tree-level-order-traversal/)
25. [Sqrt(x)](https://leetcode.com/problems/sqrt-x/)
26. [Design Front Middle Back Queue](https://leetcode.com/problems/design-front-middle-back-queue/)
...
33. [Minimum Cost to Connect All Points](https://leetcode.com/problems/min-cost-to-connect-all-points/)
34. [Critical Connections in a Network](https://leetcode.com/problems/critical-connections-in-a-network/)
