...
These are not guaranteed exact interview questions. Treat this as the high-signal Datadog-style drill set: if you can solve these cleanly under time pressure, you are covering the main techniques Datadog-style live coding tends to reward.

## Problem Set

01. [Logger Rate Limiter](https://leetcode.com/problems/logger-rate-limiter/)
02. [Design Hit Counter](https://leetcode.com/problems/design-hit-counter/)
03. [Moving Average from Data Stream](https://leetcode.com/problems/moving-average-from-data-stream/)
...
06. [LFU Cache](https://leetcode.com/problems/lfu-cache/)
07. [Insert Delete GetRandom O(1)](https://leetcode.com/problems/insert-delete-getrandom-o1/)
08. [Sliding Window Maximum](https://leetcode.com/problems/sliding-window-maximum/)
09. [Sliding Window Median](https://leetcode.com/problems/sliding-window-median/)
