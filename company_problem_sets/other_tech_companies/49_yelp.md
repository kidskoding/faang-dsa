...
Yelp - Major LeetCode-style problems to drill for Yelp SWE interviews

Focus: search/ranking, heaps, strings, graphs, intervals, tries, trees, and DP.

These are not guaranteed exact interview questions. Treat this as the high-signal Yelp-style drill set: if you can solve these cleanly under time pressure, you are covering the main techniques Yelp-style live coding tends to reward.
...
9. [Time Based Key-Value Store](https://leetcode.com/problems/time-based-key-value-store/)
...
18. [Reconstruct Itinerary](https://leetcode.com/problems/reconstruct-itinerary/)
19. [Meeting Rooms II](https://leetcode.com/problems/meeting-rooms-ii/)
...
22. [Binary Tree Vertical Order Traversal](https://leetcode.com/problems/binary-tree-vertical-order-traversal/)
