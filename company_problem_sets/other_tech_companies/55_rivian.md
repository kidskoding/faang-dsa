...
Rivian - Major LeetCode-style problems to drill for Rivian SWE interviews

Focus: graph pathfinding, grids, heaps, binary search, intervals, greedy scheduling, trees, and DP.

These are not guaranteed exact interview questions. Treat this as the high-signal Rivian-style drill set: if you can solve these cleanly under time pressure, you are covering the main techniques Rivian-style live coding tends to reward.
...
9. [Max Area of Island](https://leetcode.com/problems/max-area-of-island/)
...
17. [Find Peak Element](https://leetcode.com/problems/find-peak-element/)
18. [Kth Largest Element in an Array](https://leetcode.com/problems/kth-largest-element-in-an-array/)
...
23. [Task Scheduler](https://leetcode.com/problems/task-scheduler/)
