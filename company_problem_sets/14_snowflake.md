...
Snowflake - Commonly reported LeetCode/HackerRank/live-coding patterns for Snowflake SWE interviews
...
2. [Design In-Memory File System](https://leetcode.com/problems/design-in-memory-file-system/)
3. [Design Search Autocomplete System](https://leetcode.com/problems/design-search-autocomplete-system/)
4. [Design Add and Search Words Data Structure](https://leetcode.com/problems/design-add-and-search-words-data-structure/)
...
7. [Logger Rate Limiter](https://leetcode.com/problems/logger-rate-limiter/)
8. [Accounts Merge](https://leetcode.com/problems/accounts-merge/)
...
11. [Network Delay Time](https://leetcode.com/problems/network-delay-time/)
12. [Path Sum](https://leetcode.com/problems/path-sum/)
13. [Minimum Size Subarray Sum](https://leetcode.com/problems/minimum-size-subarray-sum/)
...
16. [Find Critical and Pseudo-Critical Edges in Minimum Spanning Tree](https://leetcode.com/problems/find-critical-and-pseudo-critical-edges-in-minimum-spanning-tree/)
17. [Path With Minimum Effort](https://leetcode.com/problems/path-with-minimum-effort/)
18. [Interval List Intersections](https://leetcode.com/problems/interval-list-intersections/)
...
23. [Palindrome Number](https://leetcode.com/problems/palindrome-number/)
24. [Predict the Winner](https://leetcode.com/problems/predict-the-winner/)
25. [Binary Tree Level Order Traversal](https://leetcode.com/problems/binary-tree-level-order-traversal/)
26. [Design Skiplist](https://leetcode.com/problems/design-skiplist/)
27. [Minimize Max Distance to Gas Station](https://leetcode.com/problems/minimize-max-distance-to-gas-station/)
28. [All Nodes Distance K in Binary Tree](https://leetcode.com/problems/all-nodes-distance-k-in-binary-tree/)
...
33. [Design Underground System](https://leetcode.com/problems/design-underground-system/)
