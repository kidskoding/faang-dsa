...
def ship_within_days(weights: list[int], days: int) -> int:
    # Problem 12: Capacity To Ship Packages Within D Days
...
def split_array(nums: list[int], k: int) -> int:
    # Problem 16: Split Array Largest Sum
...
def find_median_sorted_arrays(nums1: list[int], nums2: list[int]) -> float:
    # Problem 17: Median of Two Sorted Arrays
...
def min_speed_on_time(dist: list[int], hour: float) -> int:
    # Problem 19: Minimum Speed to Arrive on Time
...
def smallest_divisor(nums: list[int], threshold: int) -> int:
    # Problem 20: Find the Smallest Divisor Given a Threshold
...
def find_duplicate(nums: list[int]) -> int:
    # Problem 21: Find the Duplicate Number
...
def min_days(bloom_day: list[int], m: int, k: int) -> int:
    # Problem 22: Minimum Number of Days to Make m Bouquets
...
def find_kth_number(m: int, n: int, k: int) -> int:
    # Problem 25: Kth Smallest Number in Multiplication Table
...
def smallest_distance_pair(nums: list[int], k: int) -> int:
    # Problem 26: Find K-th Smallest Pair Distance
