def fraction_to_decimal(numerator: int, denominator: int) -> str:
    # Problem 8: Fraction To Recurring Decimal
...
def gcd_of_strings(str1: str, str2: str) -> str:
    # Problem 9: Greatest Common Divisor of Strings
...
def common_factors(a: int, b: int) -> int:
    # Problem 10: Number of Common Factors
...
def smallest_even_multiple(n: int) -> int:
    # Problem 11: Smallest Even Multiple
...
def find_gcd(nums: list[int]) -> int:
    # Problem 12: Find Greatest Common Divisor of Array
...
def can_measure_water(jug1_capacity: int, jug2_capacity: int, target: int) -> bool:
    # Problem 13: Water and Jug Problem
