# SWE New Grad - Expedia Group: Mock Superday #1
...
1. [Travel Product Modeling (OOP Design)](PROB_04.md)
   - Source: OOP / object-modeling design round

## Interview #3: Algorithmic Problem Solving
