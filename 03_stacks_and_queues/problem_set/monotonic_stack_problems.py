...
def next_greater_element(nums1: list[int], nums2: list[int]) -> list[int]:
    # Problem 25: Next Greater Element I
...
def next_greater_elements(nums: list[int]) -> list[int]:
    # Problem 27: Next Greater Element II
...
def trap(height: list[int]) -> int:
    # Problem 32: Trapping Rain Water
...
def remove_duplicate_letters(s: str) -> str:
    # Problem 34: Remove Duplicate Letters
...
def sum_subarray_mins(arr: list[int]) -> int:
    # Problem 36: Sum Of Subarray Minimums
...
def sub_array_ranges(nums: list[int]) -> int:
    # Problem 37: Sum Of Subarray Ranges
