def character_replacement(s: str, k: int) -> int:
    # Problem 18: Longest Repeating Character Replacement
...
def check_inclusion(s1: str, s2: str) -> bool:
    # Problem 19: Permutation in String
...
def min_window(s: str, t: str) -> str:
    # Problem 25: Minimum Window Substring
...
def length_of_longest_substring_k_distinct(s: str, k: int) -> int:
    # Problem 22: Longest Substring with At Most K Distinct Characters
...
def subarrays_with_k_distinct(nums: list[int], k: int) -> int:
    # Problem 23: Subarrays with K Different Integers
...
def number_of_subarrays(nums: list[int], k: int) -> int:
    # Problem 24: Count Number of Nice Subarrays
...
def number_of_substrings(s: str) -> int:
    # Problem 26: Number of Substrings Containing All Three Characters
...
def num_subarrays_with_sum(nums: list[int], goal: int) -> int:
    # Problem 27: Binary Subarrays With Sum
...
def balanced_string(s: str) -> int:
    # Problem 28: Replace the Substring for Balanced String
...
def find_substring(s: str, words: list[str]) -> list[int]:
    # Problem 29: Substring with Concatenation of All Words
...
def min_window_subsequence(s1: str, s2: str) -> str:
    # Problem 30: Minimum Window Subsequence
