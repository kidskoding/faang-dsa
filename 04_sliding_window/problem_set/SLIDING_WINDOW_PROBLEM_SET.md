...
- solves: `get_averages`
- Pattern: a fixed window of width 2k+1 with a running sum, and -1 wherever the
  window would fall off either end.

### 9. [Sliding Subarray Beauty](https://leetcode.com/problems/sliding-subarray-beauty/)

- solves: `get_subarray_beauty`
- Pattern: values are bounded, so keep a count array instead of sorting and walk
  it to find the xth smallest negative.
...
### 14. [Longest Subarray of 1's After Deleting One Element](https://leetcode.com/problems/longest-subarray-of-1s-after-deleting-one-element/)
...
### 15. [Subarray Product Less Than K](https://leetcode.com/problems/subarray-product-less-than-k/)
...
### 16. [Get Equal Substrings Within Budget](https://leetcode.com/problems/get-equal-substrings-within-budget/)

- solves: `equal_substring`
- Pattern: expand right accumulating conversion cost, shrink left while the cost exceeds `maxCost`.

### 17. [Maximum Erasure Value](https://leetcode.com/problems/maximum-erasure-value/)
...
### 18. [Frequency of the Most Frequent Element](https://leetcode.com/problems/frequency-of-the-most-frequent-element/)

- solves: `max_frequency`
- Pattern: sort, then slide a window where cost to raise all to the right edge stays within `k`.

### 19. [Longest Nice Subarray](https://leetcode.com/problems/longest-nice-subarray/)
...
### 21. [Permutation in String](https://leetcode.com/problems/permutation-in-string/)
...
### 23. [Fruit Into Baskets](https://leetcode.com/problems/fruit-into-baskets/)
...
### 25. [Subarrays with K Different Integers](https://leetcode.com/problems/subarrays-with-k-different-integers/)

- solves: `subarrays_with_k_distinct`
- Pattern: exactly-`k` count via `atMost(k) - atMost(k - 1)` using two frequency-map windows.

### 26. [Count Number of Nice Subarrays](https://leetcode.com/problems/count-number-of-nice-subarrays/)
...
### 28. [Number of Substrings Containing All Three Characters](https://leetcode.com/problems/number-of-substrings-containing-all-three-characters/)
...
### 29. [Binary Subarrays With Sum](https://leetcode.com/problems/binary-subarrays-with-sum/)

- solves: `num_subarrays_with_sum`
- Pattern: exact-sum count via `atMost(goal) - atMost(goal - 1)` over a 0/1 window.

### 30. [Replace the Substring for Balanced String](https://leetcode.com/problems/replace-the-substring-for-balanced-string/)

- solves: `balanced_string`
- Pattern: shrink the smallest window whose removal lets the outside counts be rebalanced to `n / 4` each.

### 31. [Substring with Concatenation of All Words](https://leetcode.com/problems/substring-with-concatenation-of-all-words/)

- solves: `find_substring`
- Pattern: word-length-stepped windows with a word frequency map, one pass per starting offset.

### 32. [Minimum Window Subsequence](https://leetcode.com/problems/minimum-window-subsequence/)
...
### 33. [Sliding Window Maximum](https://leetcode.com/problems/sliding-window-maximum/)
...
### 34. [Longest Continuous Subarray With Absolute Diff Less Than or Equal to Limit](https://leetcode.com/problems/longest-continuous-subarray-with-absolute-diff-less-than-or-equal-to-limit/)
...
### 36. [Count Subarrays With Fixed Bounds](https://leetcode.com/problems/count-subarrays-with-fixed-bounds/)
...
### 37. [Continuous Subarrays](https://leetcode.com/problems/continuous-subarrays/)
...
### 39. [Maximum Number of Robots Within Budget](https://leetcode.com/problems/maximum-number-of-robots-within-budget/)
